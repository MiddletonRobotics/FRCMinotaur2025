...
public class FieldConstants {
  ...
  public static final RectanglePoseArea fieldArea = new RectanglePoseArea(new Translation2d(0, 0), fieldDimensions);
  ...
  public static class Processor {
    public static final Pose2d centerFace = new Pose2d(AprilTagLayoutType.OFFICIAL.getLayout().getTagPose(16).get().getX(), 0, Rotation2d.fromDegrees(90));
  }
  ...
  public static class CoralStation {
    ...
    public static final Pose2d rightCenterFace = new Pose2d(Units.inchesToMeters(33.526), Units.inchesToMeters(25.824), Rotation2d.fromDegrees(144.011 - 90));
    public static final Pose2d leftCenterFace = new Pose2d(rightCenterFace.getX(), fieldWidth - rightCenterFace.getY(), Rotation2d.fromRadians(-rightCenterFace.getRotation().getRadians()));
  }
  ...
  public static class StagingPositions {
    ...
    public static final Pose2d middleIceCream = new Pose2d(Units.inchesToMeters(48), fieldWidth / 2.0, new Rotation2d());
    public static final Pose2d leftIceCream = new Pose2d(Units.inchesToMeters(48), middleIceCream.getY() + separation, new Rotation2d());
    public static final Pose2d rightIceCream = new Pose2d(Units.inchesToMeters(48), middleIceCream.getY() - separation, new Rotation2d());
  }
  ...
  public enum ReefLevel {
    ...
    public static ReefLevel fromLevel(int level) {
      return Arrays.stream(values()).filter(height -> height.ordinal() == level).findFirst().orElse(L4);
    }
  ...
  public enum AprilTagLayoutType {
    ...
    AprilTagLayoutType(String name) {
      if (Constants.DriverConstants.disableHAL) {
        try {
          layout = new AprilTagFieldLayout(Path.of("src", "main", "deploy", "apriltags", fieldType.getJsonFolder(), "2025-official.json"));
        } catch (IOException e) {
          throw new RuntimeException(e);
        }
      } else {
        try {
          layout = new AprilTagFieldLayout(Path.of(Filesystem.getDeployDirectory().getPath(), "apriltags", fieldType.getJsonFolder(), name + ".json"));
        } catch (IOException e) {
          throw new RuntimeException(e);
        }
      }
