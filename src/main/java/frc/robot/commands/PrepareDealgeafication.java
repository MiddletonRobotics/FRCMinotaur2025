...
public class PrepareDealgeafication extends SequentialCommandGroup {
    public PrepareDealgeafication(DealgeafierSubsystem dealgeafierSubsystem, ElevatorSubsystem2 elevatorSubsystem2) {
        ...
        addCommands
        (
            Elevator2Commands.runElevatorToD2(elevatorSubsystem2).alongWith(new InstantCommand(() -> dealgeafierSubsystem.startRolling(-1))).alongWith(DealgeafierCommands.runPivotToReef(dealgeafierSubsystem))
        );
    }
}
