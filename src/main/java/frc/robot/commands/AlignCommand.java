...
public class AlignCommand extends Command {
    ...
    public AlignCommand(CommandSwerveDrivetrain swerve, double targetDistance, double targetAngle) {
        m_Swerve = swerve;
    ...
    @Override
    public void execute() {
        double currentTargetTX = LimelightHelper.getTX("limelight-left");
        double currentTargetTY = LimelightHelper.getTY("limelight-left");
        double currentTargetAngle = LimelightHelper.getTA("limelight-left");
