...
public class CoralCommands {
    public static Command funnelIntakingUntilBroken(CoralSubsystem coralSubsystem, LEDSubsystem ledSubsystem) {
        return new SequentialCommandGroup(
          ...
          new RunCommand(() -> coralSubsystem.spinCoral(-0.75), coralSubsystem).until(() -> coralSubsystem.firstBeamBroken()).withTimeout(4),
          new InstantCommand(() -> ledSubsystem.setPattern(BlinkinPattern.GOLD)),
          new RunCommand(() -> coralSubsystem.spinCoral(-0.3), coralSubsystem).until(() -> coralSubsystem.secondBeamBreak()).withTimeout(0.8),
          new RunCommand(() -> coralSubsystem.spinCoral(-0.25), coralSubsystem).until(() -> !coralSubsystem.firstBeamBroken()).withTimeout(0.8),
